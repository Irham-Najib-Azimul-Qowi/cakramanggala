...
@section('title', 'Buat Catatan Perjalanan Baru')
    ...
    <div class="admin-card p-0 overflow-hidden border-0 shadow-lg mb-5">
        <div class="p-4 p-lg-5" style="background: var(--primary); color: #fff; position: relative; overflow: hidden;">
            <div style="position: relative; z-index: 2;">
                <h1 class="h3 fw-black mb-1" style="letter-spacing: -0.01em;">BUAT CATATAN PERJALANAN</h1>
                <p class="mb-0 text-white-50 small fw-bold text-uppercase" style="letter-spacing: 0.1em;">Arsip & Jurnal Perjalanan Alam Bebas</p>
            </div>
        ...
        <div class="p-4 p-lg-5">
            <form action="{{ route('dashboard.catatan-perjalanan.store') }}" method="POST" enctype="multipart/form-data">
                @csrf
                    ...
                    <div class="col-lg-8">
                        <div class="mb-5">
                            ...
                            <input type="text" name="judul" class="form-control admin-input @error('judul') is-invalid @enderror"
                                value="{{ old('judul') }}" placeholder="Contoh: Catatan Perjalanan Diklat Akhir 2025" required
                        ...
                        <div class="mb-5">
                            ...
                            <textarea name="deskripsi" class="form-control admin-input @error('deskripsi') is-invalid @enderror"
                                rows="2" placeholder="Deskripsi ringkas mengenai isi jurnal perjalanan ini...">{{ old('deskripsi') }}</textarea>
                        ...
                        <div class="mb-0">
                            ...
                            <textarea name="konten" class="form-control admin-input @error('konten') is-invalid @enderror"
                                rows="18" placeholder="Tuliskan seluruh isi catatan perjalanan, evaluasi, rute, dan log harian..." required>{{ old('konten') }}</textarea>
                        ...
                        <div class="admin-card mb-4" style="background: rgba(255,255,255,0.02); border-color: rgba(255,255,255,0.05); padding: 2rem;">
                            ...
                            <div class="mb-4">
                                ...
                                <input type="text" name="penulis" class="form-control admin-input @error('penulis') is-invalid @enderror"
                                    value="{{ old('penulis') }}" placeholder="Nama Anggota/Penulis" required>
                            ...
                            <div class="mb-4">
                                ...
                                <input type="text" name="angkatan" class="form-control admin-input @error('angkatan') is-invalid @enderror"
                                    value="{{ old('angkatan') }}" placeholder="Contoh: Angkatan XIII">
                            ...
                            <div class="mb-4">
                                ...
                                <input type="text" name="lokasi" class="form-control admin-input @error('lokasi') is-invalid @enderror"
                                    value="{{ old('lokasi') }}" placeholder="Contoh: Gunung Welirang">
                            ...
                            <div class="mb-4">
                                ...
                                <select name="status" class="form-select admin-select @error('status') is-invalid @enderror" required>
                                    ...
                                    <option value="published" {{ old('status', 'published') == 'published' ? 'selected' : '' }}>PUBLIKASIKAN SEKARANG</option>
                                </select>
                            ...
                            <div class="mb-4">
                                <label class="form-label fw-bold x-small text-white-50 text-uppercase mb-2"
                                    style="letter-spacing: 0.1em; font-size: 0.6rem;">Unggah Berkas Lampiran (.PDF / .DOCX / .EML)</label>
