    ...
    <section class="section-shell" style="background-color: var(--dark-color); color: #fff; min-height: 80vh;">
        <div class="container">
            ...
            <div class="row justify-content-center mb-5" data-aos="fade-up">
                <div class="col-lg-10">
                    <form method="GET" action="{{ route('activities.gunung-hutan') }}" class="row g-3 justify-content-center">
                        <div class="col-md-6">
                        ...
                        <div class="col-md-2">
                            <a href="{{ route('activities.gunung-hutan') }}" class="btn btn-outline-light w-100 py-3 rounded-0 border-0"
                            ...
                            <a href="{{ route('activities.show', $kegiatan->id) }}" class="text-decoration-none">
                                <article class="doc-card" style="height: 440px;">
                                    <div class="doc-card__img-container">
                                        <img src="{{ $kegiatan->gambar_utama ? asset($kegiatan->gambar_utama) : asset('image/fotobersejarah2.jpg') }}"
